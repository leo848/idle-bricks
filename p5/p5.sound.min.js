	...
	function (t, e, n) {
		...
		void 0 !== S.createStereoPanner
			? (x = (function () {
					function n(t, e) {
						b(this, n),
							(this.stereoPanner = this.input = S.createStereoPanner()),
				...
				})(o, [
					{
						...
						value: function (n, i) {
							...
							if (void 0 !== this.url && '' !== this.url) {
								...
								(t.onload = function () {
									r.panner &&
										R.decodeAudioData(t.result, function (t) {
											r.panner &&
												((r.buffer = t),
												r.panner.inputChannels(t.numberOfChannels),
												n && n(r));
					...
					},
					{
						...
						value: function () {
							return this.reversed
								? Math.abs(this._lastPos - this.buffer.length) / R.sampleRate
						...
						value: function () {
							...
							return (
								...
								(i.buffer = (function (t) {
									for (
										var e = t.length,
											n = R.createBuffer(1, t.length, R.sampleRate),
		...
		var xt = (function () {
			function r(t, e) {
				...
				!(function (t, e) {
					...
					((n = gt(this, bt(r).call(this, t, 'sawtooth'))).w = e || 0),
					(n.osc2 = new tt(t)),
			...
			return (
				...
				(function (t, e, n) {
					...
					},
					{
						...
						value: function () {
							if (
								(Jt(Kt(s.prototype), 'dispose', this).call(this), this.bands)
							) {
		...
		var le = (function () {
			function e() {
				...
				return (
					...
					((t = se(this, ue(e).call(this))).panner = t.ac.createPanner()),
				...
				return (
					...
					Te(r, [
						...
						},
						{
							key: 'dispose',
							value: function () {
								for (var t in (xe(Se(r.prototype), 'dispose', this).call(this),
								this.impulses))
		...
		var Ee = (function () {
			function t() {
				!(function (t, e) {
					...
					(this.clock = new Re.a({ callback: this.ontick.bind(this) })),
					(this.syncedParts = []),
					(this.bpm = 120),
					this._init(),
					(this.prevTick = 0),
